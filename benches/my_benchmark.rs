...
use spec_spars::{sparsifier::{Sparsifier,SparsifierParameters}, utils::Benchmarker, tests::make_random_evim_matrix, stream::InputStream};
use sprs::CsMat;
...
fn jl_sketch_naive_virus(c: &mut Criterion) {
    ...
    let mut sparsifier = Sparsifier::new(num_rows, &parameters);
