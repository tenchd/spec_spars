...
To run an example where the virus dataset is sparsified, you can `cargo run --release`. This currently uses my semi-optimized multithreaded JL sketch multiplication code.

To compare performance of the two jl sketch methods, you can run `cargo test --release jl_sketch_equiv -- --nocapture`.
